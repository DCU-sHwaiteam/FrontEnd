    ...
    <v-container class="form-container">
      <v-card class="form-card" elevation="6">
        ...
        <v-card-actions class="justify-end">
          <v-btn color="grey" class="rounded-pill" @click="navigateToSearch">돌아가기</v-btn>
          <v-btn color="primary" class="rounded-pill" :disabled="!isFormValid" @click="registerClub">등록</v-btn>
        </v-card-actions>
      </v-card>
    </v-container>
  </v-app>
